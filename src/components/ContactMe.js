            ...
            <div class="columns is-centered">
              <div class="column is-three-quarters">
                ...
                <ul id="contact-info">
                  <li>
                    <span>
                      <img id="marker" src={Marker} alt=""></img>
                    </span>
                    Currently: Texas
                  </li>
                    ...
                    >
                      <div class="column" id="githubLink">
                        <figure class="image is-64x64">
                          <a
                            href="https://github.com/kristiansaenz"
                            class="image"
                          >
                            <img
                              src={GithubLogo}
                      ...
                      <div class="column" id="linkedinLink">
                        <figure class="image is-64x64">
                          <a
                            href="https://www.linkedin.com/in/kristian-saenz-290aa5104/"
                            class="image"
                          >
                      ...
                      <div class="column" id="artstationLink">
                        <figure class="image is-64x64">
                          <a
                            href="https://www.artstation.com/kristiansaenz"
                            class="image"
                          >
                      ...
                      <div class="column" id="TrelloLink">
                        <figure class="image is-64x64">
                          <a
                            href="https://trello.com/kristiansaenz/boards"
                            class="image"
                          >
